...
{
    /**
     * Restore canonical descriptions for projects whose description was blanked
     * by the edit form bug (the empty textarea submitted an empty value that was
     * nulled on save). Only fills rows that are currently null, so intact and
     * custom descriptions are left untouched.
     *
    ...
    {
        // No-op: this migration only restores lost data.
    }
};
